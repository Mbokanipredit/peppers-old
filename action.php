			...
			echo "
				<div class='col-md-3'>
							<div class='panel panel-info'>
								<div class='panel-heading'style='background:#0077B5; font-weight:bold;'>$pro_title</div>
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:220px; height:250px;'/>
								</div>
								<div class='panel-heading' style='background:#0077B5; font-weight:bold;'>".CURRENCY.". $pro_price /-
									<button pid='$pro_id' style='float:right; padding:.5rem; box-shadow: 2px 2px 2px #fff; background:#0077B5; border-color:#ffff; border-raduis:4px;' id='product' class='btn-danger btn-xs'>Add To Cart</button>
								</div>
							</div>
						</div>	
			";
...
if (isset($_POST["Common"])) {
	...
	if (isset($_POST["getCartItem"])) {
		if (mysqli_num_rows($query) > 0) {
			...
			?>
				<a style="float:right;background:#0077B5;" href="cart.php" class="btn btn-warning">Edit&nbsp;&nbsp;<span class="glyphicon glyphicon-edit"></span></a>
			<?php
			exit();
		}
	}
	if (isset($_POST["checkOutDetails"])) {
		if (mysqli_num_rows($query) > 0) {
			echo "<form method='post' action='login_form.php'>";
						...
						'<div class="row">
								<div class="col-md-2">
									<div class="btn-group">
										...
										<a href="#" update_id="'.$product_id.'" class="btn btn-primary update" style="background:#0077B5"><span class="glyphicon glyphicon-ok-sign"></span></a>
									</div>
								</div>
				...
				// uncomment after getting AOUTH file 
					...
					echo '
						...
						<form action="payment_products.php" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/peppers/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/peppers/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/peppers/cancel.php"/>
									<input type="hidden" name="currency_code" value="USD"/>
									<input type="hidden" name="custom" value="'.$_SESSION["uid"].'"/>
									<input style="float:right;margin-right:80px;" type="image" name="submit"
										src="https://www.shift4shop.com/images/credit-card-logos/cc-lg-4.png" width="200" alt="PayPal Checkout"
