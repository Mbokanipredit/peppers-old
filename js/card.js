...
mDetaills = document.querySelector('.card-detaills'),
cDetails = document.querySelector('.card-details');


function doFun(){
 tColorA.style.color = "#0077B5";
 tColorB.style.color = "#444";
 tColorC.style.color = "#444";
 iconA.style.color = "#0077B5";
 iconB.style.color = "#aaa";
 iconC.style.color = "#aaa";
 cDetails.style.display = "block";
 mDetaills.style.display = "none";
}
function doFunA(){
 tColorA.style.color = "#444";
 tColorB.style.color = "#0077B5";
 tColorC.style.color = "#444";
 iconA.style.color = "#aaa";
 iconB.style.color = "#0077B5";
 iconC.style.color = "#aaa";
 cDetails.style.display = "none";
 mDetaills.style.display = "block";
}
function doFunB(){
 tColorA.style.color = "#444";
 tColorB.style.color = "#444";
 tColorC.style.color = "#0077B5";
 iconA.style.color = "#aaa";
 iconB.style.color = "#aaa";
 iconC.style.color = "#0077B5";
 cDetails.style.display = "none";
 mDetaills.style.display = "none";
}
...
cNumber.addEventListener('keyup', function(e){
 ...
 if(num.length<16){
  ...
  ccNum.style.border="1px solid #0077B5";
 }
});
...
eDate.addEventListener('keyup', function( e ){
 ...
 if(newInput.length<5){
  ...
  eDate.style.border="1px solid #0077B5";
 }
});
...
cvv.addEventListener('keyup', function(e){
 ...
 if(elen.length<3){
  ...
  cvvBox.style.border="1px solid #0077B5";
 }
})
