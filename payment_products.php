...
<body>
    ...
    <div class="container">
        <div class="left">
            ...
            <div class="methods">
                <div onclick="doFun()" id="tColorA" style="color: #0077B5"><i class="fa-solid fa-credit-card" style="color: #0077B5;"></i> Payment by card</div>
                <div onclick="doFunA()" id="tColorB"><i class="fa-solid fa-building-columns"></i> Payment by MTN</div>
        ...
        <div class="right">
            ...
            <div class="details">
                ...
                <div style="padding: 3px 0;">P. Quantity: <strong></strong></div>
                <div style="padding: 3px 0;">Price total: <strong>$ </strong></div>
            </div>
            <hr style="border:1px solid #ccc; margin: 0 15px;">
