...
<body>
	<div class="navbar navbar-inverse navbar-fixed-top" style="background:#ffff; border-color:#fff; padding:2rem; color:black;">
		...
		<div class="collapse navbar-collapse" id="collapse">
			...
			<li><a href="profile.php" style="color: black;text-transform:uppercase; font-size:1.3rem;">Home</a></li>
			...
			<ul class="nav navbar-nav navbar-right">
						...
						<div class="panel panel-success">
							<div class="panel-heading" style="background:#0077B5">
								<div class="row" style="color:#ffff">
									...
									<div class="col-md-3 col-xs-3">P.Image</div>
									<div class="col-md-3 col-xs-3">P.Name</div>
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color:black; background:#fff;"><span class="glyphicon glyphicon-user"></span> <?php echo "Hi, ".$_SESSION["name"]; ?></a>
